...
#####
# This is a custom 'getting started' script, made with care for blair.shotlow@gmail.com.
...
streamer = Streamer(bucket_name="Python Stream Example", bucket_key="python_example", access_key="uiXcfKDIilpmBXB0Zoyr0cuf760sNbTG")
